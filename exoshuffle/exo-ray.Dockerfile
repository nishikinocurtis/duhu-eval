...
RUN echo "alias ray5=\"ray start --num-cpus=4 --node-ip-address 192.168.10.205 \
--address='192.168.10.201:6379' --object-store-memory 16000000000 \
--resources='{\\\"worker\\\":1}'\"" >> ~/.bashrc

RUN echo "alias ray6=\"ray start --num-cpus=4 --node-ip-address 192.168.10.206 \
    --address='192.168.10.201:6379' --object-store-memory 16000000000 \
    --resources='{\\\"worker\\\":1}'\"" >> ~/.bashrc

RUN echo "alias ray7=\"ray start --num-cpus=4 --node-ip-address 192.168.10.207 \
    --address='192.168.10.201:6379' --object-store-memory 16000000000 \
    --resources='{\\\"worker\\\":1}'\"" >> ~/.bashrc

RUN echo "alias ray8=\"ray start --num-cpus=4 --node-ip-address 192.168.10.208 \
    --address='192.168.10.201:6379' --object-store-memory 16000000000 \
    --resources='{\\\"worker\\\":1}'\"" >> ~/.bashrc
